...
<p>Настоящий документ является публичной офертой (далее — «Оферта») индивидуального предпринимателя <strong>[ФИО ИП]</strong> (ИНН <strong>[ИНН]</strong>, ОГРНИП <strong>[ОГРНИП]</strong>, далее — «Исполнитель»), применяющего специальный налоговый режим «Налог на профессиональный доход» (НПД), в адрес любого дееспособного физического или юридического лица (далее — «Пользователь»), заключить Договор возмездного оказания услуг на изложенных ниже условиях.</p>
...
<p>
Индивидуальный предприниматель <strong>[ФИО]</strong><br/>
ИНН: <strong>[ИНН]</strong><br/>
ОГРНИП: <strong>[ОГРНИП]</strong><br/>
...
<h2>1. Общие положения</h2>
<p>Настоящая Политика определяет порядок обработки и защиты персональных данных пользователей сервиса MaxSurge (далее — «Сервис»). Оператором персональных данных является ИП <strong>[ФИО]</strong> (ИНН <strong>[ИНН]</strong>).</p>
...
<p>
ИП <strong>[ФИО]</strong> (ИНН <strong>[ИНН]</strong>)<br/>
Email: <a href="mailto:legal@maxsurge.ru">legal@maxsurge.ru</a><br/>
Ответственный за обработку ПДн: <strong>[ФИО]</strong>
</p>
"""
...
<h3>Реквизиты</h3>
<p>
<strong>Индивидуальный предприниматель [ФИО]</strong><br/>
ИНН: <strong>[ИНН]</strong><br/>
ОГРНИП: <strong>[ОГРНИП]</strong><br/>
Налоговый режим: НПД (самозанятый)<br/>
Сайт: <a href="https://maxsurge.ru">maxsurge.ru</a>
