...
<p>Настоящий документ является публичной офертой (далее — «Оферта») индивидуального предпринимателя <strong>Беляев Денис Михайлович</strong> (ИНН <strong>233304095766</strong>, ОГРНИП <strong>318237500162964</strong>, далее — «Исполнитель»), применяющего специальный налоговый режим «Налог на профессиональный доход» (НПД), в адрес любого дееспособного физического или юридического лица (далее — «Пользователь»), заключить Договор возмездного оказания услуг на изложенных ниже условиях.</p>
...
<p>Исполнитель применяет НПД и выставляет чек через приложение «Мой налог» ФНС России на сумму каждого полученного платежа. Чек направляется Пользователю на email, указанный при регистрации, в течение суток с момента получения оплаты.</p>
...
<ul>
  ...
  <li>направлять фискальный чек НПД по каждому платежу.</li>
</ul>
...
<p>
Индивидуальный предприниматель <strong>Беляев Денис Михайлович</strong><br/>
ИНН: <strong>233304095766</strong><br/>
ОГРНИП: <strong>318237500162964</strong><br/>
Налоговый режим: НПД (самозанятый)<br/>
...
<h2>1. Общие положения</h2>
<p>Настоящая Политика определяет порядок обработки и защиты персональных данных пользователей сервиса MaxSurge (далее — «Сервис»). Оператором персональных данных является ИП <strong>Беляев Денис Михайлович</strong> (ИНН <strong>233304095766</strong>).</p>
...
<p>
ИП <strong>Беляев Денис Михайлович</strong> (ИНН <strong>233304095766</strong>)<br/>
Email: <a href="mailto:legal@maxsurge.ru">legal@maxsurge.ru</a><br/>
Ответственный за обработку ПДн: <strong>Беляев Денис Михайлович</strong>
</p>
"""
...
<h3>Реквизиты</h3>
<p>
<strong>Индивидуальный предприниматель Беляев Денис Михайлович</strong><br/>
ИНН: <strong>233304095766</strong><br/>
ОГРНИП: <strong>318237500162964</strong><br/>
Налоговый режим: НПД (самозанятый)<br/>
Сайт: <a href="https://maxsurge.ru">maxsurge.ru</a>
